...
class RestAPIDataProvider(DataProvider):
    ...
    def _get_data(self, endpoint: str, url_params: dict = None, data: dict = None):
        """
        ...
        if url_params:
            ...
            for k, v in url_params.items():
                url += f"{k}={v}&"
            url = url[:-1]  # remove trailing ampersand
    ...
    def get_tasks(self):
        ...
        """
        endpoint = "/tasks"
        return self._get_data(endpoint, url_params={"limit": 1000})
